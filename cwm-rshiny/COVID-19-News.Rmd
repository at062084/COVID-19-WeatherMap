...
ggplot(data=dp, aes(x=Date, y=Anzahl, color=Parameter)) +
  scale_x_datetime(name="2. Welle", limits=c(as.POSIXct("2020-08-01"),as.POSIXct("2020-12-15")),  date_breaks="months", date_labels="%b",
                   sec.axis=sec_axis(name="4. Welle", trans = (~ . +hms::hms(days=322)))) +
...
Um die Dynamik der 2. und 4. Welle besser vergleichen zu können sind hier die Fallzahlen als Prozentsatz des Maximums am Höhepunkte der 2. Welle dargestellt (1=100%)
