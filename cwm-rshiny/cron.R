...
logMsg <- function(msg, sessionID="_rscript_") {
...
logMsg(paste("cron: Start Running script cron.R in ", getwd()))
...
# Bundesländer
logMsg("DownLoading CovidFallzahlen data from AGES ...")
dt <- caAgesRead_cfz()
logMsg("Downloading CovidFaelle_Timeline data from AGES ...")
dc <- caAgesRead_cftl()

# Bezirke 
logMsg("Downloading CovidFaelle_Timeline_GKZ data from AGES ...")
db <- caAgesRead_cfGKZtl()


# Construct working data frame 
logMsg("Start Joining CovidFaelle_Timeline with CovidFallzahlen and creating new features ...")
...
logMsg("Done Joining CovidFaelle_Timeline with CovidFallzahlen and creating new features")

logMsg(paste("cron: Done Running script cron.R in ", getwd()))
