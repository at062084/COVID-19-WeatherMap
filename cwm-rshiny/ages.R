...
# https://www.ages.at/fileadmin/AGES2015/Themen/Krankheitserreger_Dateien/Coronavirus/Inzidenz_Impfstatus/Inzidenz_vollstaendig_unvollstaendig_geimpft_2021-08-20.csv
...
# -------------------------------------------------------------------------------------------
# timeline-eimpfpass.csv: TimeLine Impfungen (Region, AgeGroup, Gender, Shot1, Shot2)
# -------------------------------------------------------------------------------------------
